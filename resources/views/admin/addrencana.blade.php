                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Tambah Data Rencana Pembangunan</div>
                            </div>
                                  <form role="form" action="/admin/rencana/create" method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input id="kategori" name="kategori" type="text" class="form-control"  placeholder="Masukkan Kategori...." >
                                            </div>
                                        <div class="form-group">
