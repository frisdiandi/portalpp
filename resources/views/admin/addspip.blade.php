                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Tambah Data Sistem Pengendalian Intern Pemerintah</div>
                            </div>
                                  <form role="form" action="/admin/spip/create" method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
                            <div class="card-body">
