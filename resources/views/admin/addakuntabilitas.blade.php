                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Tambah Data Akuntabilitas </div>
                            </div>
                                  <form role="form" action="/admin/akuntabilitas/create" method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
                            <div class="card-body">
                                        <div class="form-group">
                                                <label class="control-label mb-1">Judul</label>
                                                <input id="judul" name="judul" type="text" autofocus="" class="form-control" required="" placeholder="Masukkan Judul...." >
                                            </div>
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                                <label class="control-label mb-1">OPD</label>
