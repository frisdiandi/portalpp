                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Tambah Data pengelolaan Anggaran</div>
                            </div>
                                  <form role="form" action="/admin/pengelolaan/create" method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input name="kategori" id="kategori" type="text" class="form-control"  placeholder="Masukkan Kategori...." >
                                            </div>
                                        <div class="form-group">
