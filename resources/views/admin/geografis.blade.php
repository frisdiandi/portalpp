                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Geografis </div>
                                  ...
                                  <form role="form" action="/admin/geografis/updategeografis/{{$geografis->id}}" method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
                            <div class="card-body">
                                            <div class="form-group">
                                            <textarea id="geografis" name="geografis" class="form-control" cols="5">{!!$geografis->geografis!!}</textarea>
                                            </div>
                                              <br><div>
